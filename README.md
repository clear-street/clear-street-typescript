...
[![NPM version](<https://img.shields.io/npm/v/@clear-street/sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/@clear-street/sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@clear-street/sdk)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install @clear-street/sdk`
...
```ts
import ClearStreet from 'npm:@clear-street/sdk';
