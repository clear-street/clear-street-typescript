...
[![NPM version](<https://img.shields.io/npm/v/@clear-street/clearstreet.svg?label=npm%20(stable)>)](https://npmjs.org/package/@clear-street/clearstreet) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@clear-street/clearstreet)
...
```sh
npm install @clear-street/clearstreet
```
...
```ts
import ClearStreet from 'npm:@clear-street/clearstreet';
