...
const fuse = new Fuse(
  [
    ...
    'client.active.v1.assistant.prompts.runPrompt',
    ...
    'client.active.v1.iris.feedback.createFeedback',
    'client.active.v1.iris.runs.cancelRun',
    'client.active.v1.iris.runs.getRun',
    'client.active.v1.iris.runs.startRun',
    'client.active.v1.iris.threads.getThread',
    'client.active.v1.iris.threads.listThreads',
    'client.active.v1.iris.threads.messages.listMessages',
