...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.active.v1.instruments.options.contracts.getOptionContracts',
    fullyQualifiedName: 'active.v1.instruments.options.contracts.getOptionContracts',
    httpMethod: 'get',
    httpPath: '/active/v1/instruments/options/contracts',
  },
  {
  ...
  {
    clientCallName: 'client.active.v1.iris.feedback.createFeedbackDeprecated',
    fullyQualifiedName: 'active.v1.iris.feedback.createFeedbackDeprecated',
    httpMethod: 'post',
    httpPath: '/active/v1/iris/feedback',
  },
  {
    clientCallName: 'client.active.v1.iris.runs.cancelRunDeprecated',
    fullyQualifiedName: 'active.v1.iris.runs.cancelRunDeprecated',
    httpMethod: 'delete',
    httpPath: '/active/v1/iris/runs/{run_id}',
  },
  {
    clientCallName: 'client.active.v1.iris.runs.getRunDeprecated',
    fullyQualifiedName: 'active.v1.iris.runs.getRunDeprecated',
    httpMethod: 'get',
    httpPath: '/active/v1/iris/runs/{run_id}',
  },
  {
    clientCallName: 'client.active.v1.iris.runs.startRunDeprecated',
    fullyQualifiedName: 'active.v1.iris.runs.startRunDeprecated',
    httpMethod: 'post',
    httpPath: '/active/v1/iris/runs',
  },
  {
    clientCallName: 'client.active.v1.iris.threads.getThreadDeprecated',
    fullyQualifiedName: 'active.v1.iris.threads.getThreadDeprecated',
    httpMethod: 'get',
    httpPath: '/active/v1/iris/threads/{thread_id}',
  },
  {
    clientCallName: 'client.active.v1.iris.threads.listThreadsDeprecated',
    fullyQualifiedName: 'active.v1.iris.threads.listThreadsDeprecated',
    httpMethod: 'get',
    httpPath: '/active/v1/iris/threads',
  },
  {
    clientCallName: 'client.active.v1.iris.threads.messages.listMessagesDeprecated',
    fullyQualifiedName: 'active.v1.iris.threads.messages.listMessagesDeprecated',
    httpMethod: 'get',
  ...
  {
    clientCallName: 'client.active.v1.omniAI.feedback.createFeedback',
    fullyQualifiedName: 'active.v1.omniAI.feedback.createFeedback',
    httpMethod: 'post',
    httpPath: '/active/v1/omni-ai/feedback',
  },
  {
    clientCallName: 'client.active.v1.omniAI.runs.cancelRun',
    fullyQualifiedName: 'active.v1.omniAI.runs.cancelRun',
    httpMethod: 'delete',
    httpPath: '/active/v1/omni-ai/runs/{run_id}',
  },
  {
    clientCallName: 'client.active.v1.omniAI.runs.getRun',
    fullyQualifiedName: 'active.v1.omniAI.runs.getRun',
    httpMethod: 'get',
    httpPath: '/active/v1/omni-ai/runs/{run_id}',
  },
  {
    clientCallName: 'client.active.v1.omniAI.runs.startRun',
    fullyQualifiedName: 'active.v1.omniAI.runs.startRun',
    httpMethod: 'post',
    httpPath: '/active/v1/omni-ai/runs',
  },
  {
    clientCallName: 'client.active.v1.omniAI.threads.getThread',
    fullyQualifiedName: 'active.v1.omniAI.threads.getThread',
    httpMethod: 'get',
    httpPath: '/active/v1/omni-ai/threads/{thread_id}',
  },
  {
    clientCallName: 'client.active.v1.omniAI.threads.listThreads',
    fullyQualifiedName: 'active.v1.omniAI.threads.listThreads',
    httpMethod: 'get',
    httpPath: '/active/v1/omni-ai/threads',
  },
  {
    clientCallName: 'client.active.v1.omniAI.threads.messages.listMessages',
    fullyQualifiedName: 'active.v1.omniAI.threads.messages.listMessages',
    httpMethod: 'get',
    httpPath: '/active/v1/omni-ai/threads/{thread_id}/messages',
  },
  {
    clientCallName: 'client.active.v1.savedScreeners.createScreener',
    fullyQualifiedName: 'active.v1.savedScreeners.createScreener',
    httpMethod: 'post',
    httpPath: '/active/v1/saved-screeners',
  },
  {
    clientCallName: 'client.active.v1.savedScreeners.deleteScreener',
    fullyQualifiedName: 'active.v1.savedScreeners.deleteScreener',
    httpMethod: 'delete',
    httpPath: '/active/v1/saved-screeners/{screener_id}',
  },
  {
    clientCallName: 'client.active.v1.savedScreeners.getScreenerByID',
    fullyQualifiedName: 'active.v1.savedScreeners.getScreenerByID',
    httpMethod: 'get',
    httpPath: '/active/v1/saved-screeners/{screener_id}',
  },
  {
    clientCallName: 'client.active.v1.savedScreeners.listScreeners',
    fullyQualifiedName: 'active.v1.savedScreeners.listScreeners',
    httpMethod: 'get',
    httpPath: '/active/v1/saved-screeners',
  },
  {
    clientCallName: 'client.active.v1.savedScreeners.updateScreener',
    fullyQualifiedName: 'active.v1.savedScreeners.updateScreener',
    httpMethod: 'put',
    httpPath: '/active/v1/saved-screeners/{screener_id}',
  },
  {
