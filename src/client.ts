...
export class ClearStreet {
  ...
  constructor({
    ...
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('CLEAR_STREET_LOG'), 'process.env[\'CLEAR_STREET_LOG\']', this) ?? defaultLogLevel;
