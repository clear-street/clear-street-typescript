...
import { SecurityType, SortDirection, V1 } from './resources/v1/v1';
...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['CLEAR_STREET_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['CLEAR_STREET_LOG'] or 'warn' if it isn't set.
   */
...
export class ClearStreet {
  ...
  constructor({ baseURL = readEnv('CLEAR_STREET_BASE_URL'), apiKey = null, ...opts }: ClientOptions = {}) {
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('CLEAR_STREET_LOG'), "process.env['CLEAR_STREET_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('CLEAR_STREET_CUSTOM_HEADERS');
    if (customHeadersEnv) {
...
export declare namespace ClearStreet {
  ...
  export { V1 as V1, type SecurityType as SecurityType, type SortDirection as SortDirection };
