...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: ClearStreet): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: ClearStreet): Logger {
