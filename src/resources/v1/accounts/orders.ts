...
export class Orders extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.v1.accounts.orders.cancelAllOpenOrders(0);
   * ```
   */
  cancelAllOpenOrders(
    accountID: number,
   ...
   * ```ts
   * const response =
   *   await client.v1.accounts.orders.cancelOpenOrder(
   *     'order_id',
   *     { account_id: 0 },
   *   );
   * ```
   ...
   * ```ts
   * const response =
   *   await client.v1.accounts.orders.getOrderByID('order_id', {
   *     account_id: 0,
   *   });
   * ```
   */
   ...
   * @example
   * ```ts
   * const response = await client.v1.accounts.orders.getOrders(
   *   0,
   * );
   * ```
   */
   ...
   * ```ts
   * const response =
   *   await client.v1.accounts.orders.replaceOrder('order_id', {
   *     account_id: 0,
   *   });
   * ```
   */
