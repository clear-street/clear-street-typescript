...
export class CashFlowStatements extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.v1.instruments.cashFlowStatements.getInstrumentCashFlowStatements(
  ...
  getInstrumentCashFlowStatements(
    ...
    query: CashFlowStatementGetInstrumentCashFlowStatementsParams | null | undefined = {},
