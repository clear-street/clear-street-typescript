...
describe('resource analystReporting', () => {
  ...
  test.skip('getInstrumentAnalystConsensus: only required params', async () => {
    const responsePromise = client.active.v1.instruments.analystReporting.getInstrumentAnalystConsensus('security_id', { security_id_source: 'CMS' });
  ...
  test.skip('getInstrumentAnalystConsensus: required and optional params', async () => {
    const response = await client.active.v1.instruments.analystReporting.getInstrumentAnalystConsensus('security_id', {
