...
describe('resource balanceSheets', () => {
  ...
  test.skip('getInstrumentBalanceSheetStatements: only required params', async () => {
    const responsePromise = client.active.v1.instruments.balanceSheets.getInstrumentBalanceSheetStatements('security_id', { security_id_source: 'CMS' });
  ...
  test.skip('getInstrumentBalanceSheetStatements: required and optional params', async () => {
    const response = await client.active.v1.instruments.balanceSheets.getInstrumentBalanceSheetStatements('security_id', {
