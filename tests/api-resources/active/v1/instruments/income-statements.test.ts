...
describe('resource incomeStatements', () => {
  ...
  test.skip('getInstrumentIncomeStatements: only required params', async () => {
    const responsePromise = client.active.v1.instruments.incomeStatements.getInstrumentIncomeStatements('security_id', { security_id_source: 'CMS' });
  ...
  test.skip('getInstrumentIncomeStatements: required and optional params', async () => {
    const response = await client.active.v1.instruments.incomeStatements.getInstrumentIncomeStatements('security_id', {
