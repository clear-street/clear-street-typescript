...
describe('resource threads', () => {
  ...
  test.skip('createThread: only required params', async () => {
    const responsePromise = client.active.v1.omniAI.threads.createThread({ account_id: 19816, type: 'instant' });
  ...
  test.skip('getThread: only required params', async () => {
    const responsePromise = client.active.v1.omniAI.threads.getThread('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { account_id: 0 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getThread: required and optional params', async () => {
    const response = await client.active.v1.omniAI.threads.getThread('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { account_id: 0 });
  });
