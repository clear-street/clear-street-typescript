...
describe('resource orders', () => {
  ...
  test.skip('cancelAllOpenOrders', async () => {
    const responsePromise = client.v1.accounts.orders.cancelAllOpenOrders(0);
  ...
  test.skip('cancelAllOpenOrders: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.accounts.orders.cancelAllOpenOrders(
        0,
        {
  ...
  test.skip('cancelOpenOrder: only required params', async () => {
    const responsePromise = client.v1.accounts.orders.cancelOpenOrder('order_id', { account_id: 0 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('cancelOpenOrder: required and optional params', async () => {
    const response = await client.v1.accounts.orders.cancelOpenOrder('order_id', { account_id: 0 });
  });

  // Mock server tests are disabled
  test.skip('getOrderByID: only required params', async () => {
    const responsePromise = client.v1.accounts.orders.getOrderByID('order_id', { account_id: 0 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getOrderByID: required and optional params', async () => {
    const response = await client.v1.accounts.orders.getOrderByID('order_id', { account_id: 0 });
  });

  // Mock server tests are disabled
  test.skip('getOrders', async () => {
    const responsePromise = client.v1.accounts.orders.getOrders(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('getOrders: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.accounts.orders.getOrders(
        0,
        {
  ...
  test.skip('replaceOrder: only required params', async () => {
    const responsePromise = client.v1.accounts.orders.replaceOrder('order_id', { account_id: 0 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('replaceOrder: required and optional params', async () => {
    const response = await client.v1.accounts.orders.replaceOrder('order_id', {
      account_id: 0,
      limit_price: '150.50',
      quantity: '125',
      stop_price: '148.00',
  ...
  test.skip('submitOrders: only required params', async () => {
    const responsePromise = client.v1.accounts.orders.submitOrders(0, {
      orders: [
        {
          legs: [
            {
  ...
  test.skip('submitOrders: required and optional params', async () => {
    const response = await client.v1.accounts.orders.submitOrders(0, {
      orders: [
        {
          legs: [
            {
