...
describe('resource analystReporting', () => {
  ...
  test.skip('getInstrumentAnalystConsensus', async () => {
    const responsePromise = client.v1.instruments.analystReporting.getInstrumentAnalystConsensus(
  ...
  test.skip('getInstrumentAnalystConsensus: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.instruments.analystReporting.getInstrumentAnalystConsensus(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
