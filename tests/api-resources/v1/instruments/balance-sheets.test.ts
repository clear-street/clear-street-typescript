...
describe('resource balanceSheets', () => {
  ...
  test.skip('getInstrumentBalanceSheetStatements', async () => {
    const responsePromise = client.v1.instruments.balanceSheets.getInstrumentBalanceSheetStatements(
  ...
  test.skip('getInstrumentBalanceSheetStatements: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.instruments.balanceSheets.getInstrumentBalanceSheetStatements(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
        {
          from_date: 'from_date',
          page_size: 1,
