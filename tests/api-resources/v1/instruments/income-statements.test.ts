...
describe('resource incomeStatements', () => {
  ...
  test.skip('getInstrumentIncomeStatements', async () => {
    const responsePromise = client.v1.instruments.incomeStatements.getInstrumentIncomeStatements(
  ...
  test.skip('getInstrumentIncomeStatements: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.instruments.incomeStatements.getInstrumentIncomeStatements(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
        {
          from_date: 'from_date',
          page_size: 1,
